...
describe('CursoController', () => {
    test('obterCursoPorId retorna curso com status 200', async () => {
        ...
        jest.spyOn(CursoService, 'obterCursoPorId')
    ...
    test('obterTodosCursos retorna lista de cursos com status 200', async () => {
        ...
        jest.spyOn(CursoService, 'obterTodosCursos')
    ...
    test('criarCurso cria novo curso com status 201', async () => {
        ...
        jest.spyOn(CursoService, 'criarCurso')
        ...
        expect(JSON.parse(res._getData()))
            .toEqual(expect.objectContaining(novoCurso));
    ...
    test('atualizarCurso atualiza curso existente com status 200', async () => {
        ...
        jest.spyOn(CursoService, 'atualizarCurso')
    ...
    test('excluirCurso remove curso com status 204', async () => {
        jest.spyOn(CursoService, 'excluirCurso')
            .mockResolvedValue();
    ...
    test('obterTodosCursos inclui dados da instituição', async () => {
        ...
        expect(responseData)
            .toEqual([cursoComInstituicao]);

        expect(responseData[0])
            .toHaveProperty('instituicao');

        expect(responseData[0].instituicao)
            .toHaveProperty('nome');

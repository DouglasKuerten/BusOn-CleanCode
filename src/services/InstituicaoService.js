...
class InstituicaoService {
    ...
    async criarInstituicao(dados, arquivo) {
        ...
        return await Instituicao.create({ ...instituicaoBody, logoUrl: arquivo?.filename || null });
    }
    ...
    async atualizarInstituicao(id, dados, arquivo) {
        ...
        const [atualizado] = await Instituicao.update({ ...instituicaoBody, logoUrl: arquivo?.filename || instituicaoExistente.logoUrl }, { where: { id } });

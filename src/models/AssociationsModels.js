...
Associacao.hasOne(Parametro, {
  foreignKey: 'associacaoId',
  onDelete: 'CASCADE',
});
Parametro.belongsTo(Associacao, {
  foreignKey: 'associacaoId',
  onDelete: 'CASCADE',
});

TemplateDocumento.belongsTo(Associacao, {
  foreignKey: 'associacaoId',
  onDelete: 'RESTRICT',
});
Associacao.hasMany(TemplateDocumento, {
  foreignKey: 'associacaoId',
  onDelete: 'RESTRICT',
});

Instituicao.belongsTo(Associacao, {
  foreignKey: 'associacaoId',
  onDelete: 'RESTRICT',
});
Associacao.hasMany(Instituicao, {
  foreignKey: 'associacaoId',
  onDelete: 'RESTRICT',
});
...
Usuario.belongsTo(Associacao, {
  foreignKey: 'associacaoId',
  onDelete: 'RESTRICT',
});
Associacao.hasMany(Usuario, {
  foreignKey: 'associacaoId',
  onDelete: 'RESTRICT',
});
